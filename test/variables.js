...
describe('Liquid.Variable', () => {
  ...
  describe('with multiple arguments', () => {
    ...
    return it('parses when a string-argument contains an argument-separator', () => {
  ...
  it('renders', () => renderTest('worked', '{{ test }}', {
    test: 'worked',
  }));
  ...
  return it.skip("prevents 'RangeError: Maximum call stack size exceeded'", () => {
    let doc = '{{ a';
