...
describe('StandardFilters', () => {
  ...
  describe('taking string inputs', () => it('handles odd objects', () => {
    const noop = () => {};
  ...
  describe('taking array inputs', () => it('handles non-arrays', () => {
    expect(self.filters.get('sort')(1)).to.become([1]);
  }));
  Array.from(Liquid.StandardFilters.entries()).forEach(([name, filter]) => {
  ...
  describe('escape', () => it('escapes strings', () => {
    expect(self.filters.get('escape')('<strong>')).to.equal('&lt;strong&gt;');
  }));
  describe('escape_once', () => it('returns an escaped version of html without affecting existing escaped entities', () => {
    expect(self.filters.get('escape_once')('&lt;strong&gt;Hulk</strong>')).to.equal('&lt;strong&gt;Hulk&lt;/strong&gt;');
  }));
  describe('strip_html', () => it('strip html from string', () => {
  ...
  describe('replace', () => it('replace each occurrence', () => {
    expect(self.filters.get('replace')('1 1 1 1', '1', '2')).to.equal('2 2 2 2');
  }));
  describe('replace_first', () => it('replace the first occurrence', () => {
    expect(self.filters.get('replace_first')('1 1 1 1', '1', '2')).to.equal('2 1 1 1');
  }));
  describe('remove', () => it('remove each occurrence', () => {
    expect(self.filters.get('remove')('a a a a', 'a')).to.equal('   ');
  }));
  describe('remove_first', () => it('remove the first occurrence', () => {
  ...
  describe('truncate', () => it('truncates', () => {
  ...
  describe('truncatewords', () => it('truncates', () => {
  ...
  describe('first', () => it('returns first element', () => {
