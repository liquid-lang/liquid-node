...
(function() {
  var HTML_ESCAPE, HTML_ESCAPE_ONCE_REGEXP, HTML_ESCAPE_REGEXP, Iterable, Promise, flatten, isNumber, isString, strftime, toDate, toIterable, toNumber, toObjectString, toString;
  ...
  isNumber = function(input) {
    return !Array.isArray(input) && (input - parseFloat(input)) >= 0;
  };
